WITH all_node_level_1 AS (
    {% set node_level_1_tables = [
        'kc_pura_vida__Node_Level_1',
        'kc_tim_hortons__Node_Level_1',
        'km_merrychef__Node_Level_1'
    ] %}
    {% for table in node_level_1_tables %}
